  ...
  return (
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>¡Seña confirmada!</h1>
        <p style={styles.subtitle}>
          Tu pago fue procesado correctamente. Tu turno está reservado.
        </p>
        {externalReference && (
          <p style={styles.ref}>Referencia: <code style={styles.code}>{externalReference}</code></p>
        )}
        <Link href="/reservar" style={styles.btn}>Hacer otra reserva</Link>
      </div>
    </main>
  )
}
